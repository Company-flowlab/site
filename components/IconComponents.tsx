...
export const FlowLabLogo: React.FC<IconProps> = ({ className }) => (
    <svg viewBox="0 0 100 100" className={className} xmlns="http://www.w3.org/2000/svg">
        <defs>
            <linearGradient id="logoGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" style={{stopColor: '#FF7A00'}} />
                <stop offset="25%" style={{stopColor: '#FF2D95'}} />
                <stop offset="50%" style={{stopColor: '#6A00FF'}} />
                <stop offset="100%" style={{stopColor: '#3B82F6'}} />
            </linearGradient>
        </defs>
        <path d="M 20,10 L 80,50 L 20,90 Z" fill="url(#logoGradient)" />
    </svg>
);
...
export const TargetIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 21a9 9 0 100-18 9 9 0 000 18zM12 3v3m0 12v3m-9-9h3m12 0h3M12 15a3 3 0 100-6 3 3 0 000 6z" />
  </svg>
);
